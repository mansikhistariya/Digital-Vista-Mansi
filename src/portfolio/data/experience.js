export const experiences = [
  {
    ...
    side: "right",
    achievements: [
      "Architected and delivered scalable frontend applications using React.js, Next.js, TypeScript, and Tailwind CSS across 3+ concurrent client projects.",
      ...
      "Improved Lighthouse performance scores through lazy loading, code splitting, and frontend optimisation techniques.",
  ...
  },
  {
    ...
    achievements: [
      ...
      "Integrated third-party APIs and implemented form validation using Yup, improving frontend reliability.",
